...
void two_pendulum_model_afee0aca_49_perturbSimJointPrimitiveState(const void
...
void two_pendulum_model_afee0aca_49_perturbFlexibleBodyState(const void *mech,
...
void two_pendulum_model_afee0aca_49_constructStateVector(const void *mech, const
...
void two_pendulum_model_afee0aca_49_extractSolverStateVector(const void *mech,
...
void two_pendulum_model_afee0aca_49_extractDiscreteStateVector(const void *mech,
...
boolean_T two_pendulum_model_afee0aca_49_isPositionViolation(const void *mech,
...
boolean_T two_pendulum_model_afee0aca_49_isVelocityViolation(const void *mech,
  const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId two_pendulum_model_afee0aca_49_projectStateSim(const void *mech,
...
void two_pendulum_model_afee0aca_49_computeConstraintError(const void *mech,
...
boolean_T two_pendulum_model_afee0aca_49_hasJointUpwardModeChange(const void
...
PmfMessageId two_pendulum_model_afee0aca_49_performJointUpwardModeChange(const
...
void two_pendulum_model_afee0aca_49_onModeChangedCutJoints(const void *mech,
...
void two_pendulum_model_afee0aca_49_setVariableModeJointsToLocked(const void
  *mech, int *modeVector)
{
  (void) mech;
  (void) modeVector;
