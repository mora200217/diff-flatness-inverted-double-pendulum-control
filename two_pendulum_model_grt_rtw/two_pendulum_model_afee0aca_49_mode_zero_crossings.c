...
const NeZCData *two_pendulum_model_afee0aca_49_ZCData = NULL;
PmfMessageId two_pendulum_model_afee0aca_49_computeAsmModeVector(const double
...
PmfMessageId two_pendulum_model_afee0aca_49_computeSimModeVector(const double
  *input, const double *inputDot, const double *inputDdot, int *modeVector,
  double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId two_pendulum_model_afee0aca_49_computeZeroCrossings(const
