...
#include "nesl_rtw.h"
#include "two_pendulum_model_afee0aca_49.h"
#include "two_pendulum_model_afee0aca_1_gateway.h"

void two_pendulum_model_afee0aca_1_gateway(void)
{
  NeModelParameters modelparams = { (enum NeSolverTypeTag)0, 0.001, 0.001, 0.001,
    ...
    enum SscLoggingSettingTag)0, 702158854.0, TRUE, FALSE, FALSE };
  ...
  two_pendulum_model_afee0aca_49_dae(&dae,
    &modelparams,
    &solverparams);
