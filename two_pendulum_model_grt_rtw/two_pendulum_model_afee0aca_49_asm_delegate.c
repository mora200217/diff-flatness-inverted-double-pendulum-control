...
void two_pendulum_model_afee0aca_49_setTargets(const RuntimeDerivedValuesBundle *
...
void two_pendulum_model_afee0aca_49_initializeTrackedAngleState(const void *mech,
...
void two_pendulum_model_afee0aca_49_computeDiscreteState(const void *mech, const
...
void two_pendulum_model_afee0aca_49_adjustPosition(const void *mech, const
...
void two_pendulum_model_afee0aca_49_perturbAsmJointPrimitiveState(const void
...
void two_pendulum_model_afee0aca_49_computePosDofBlendMatrix(const void *mech,
...
void two_pendulum_model_afee0aca_49_computeVelDofBlendMatrix(const void *mech,
  size_t stageIdx, size_t primIdx, const double *state, int partialType, double *
  matrix)
{
  (void) mech;
...
void two_pendulum_model_afee0aca_49_projectPartiallyTargetedPos(const void *mech,
...
void two_pendulum_model_afee0aca_49_propagateMotion(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const double *state, double *motionData)
{
  ...
  xx[4] = sin(xx[2]);
  xx[2] = 2.0;
  xx[5] = 0.3999999999333334;
  xx[6] = xx[5] * xx[4];
  xx[7] = xx[2] * xx[6] * xx[3];
  xx[8] = 0.02499999999999997;
  ...
  motionData[6] = 0.02500000000000002;
  motionData[7] = - xx[3];
  motionData[8] = xx[0];
  motionData[9] = - xx[4];
  motionData[10] = xx[0];
...
void two_pendulum_model_afee0aca_49_computeTransforms(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const double *state, double *motionData)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
  const int *rtdvi = rtdv->mInts.mValues;
...
size_t two_pendulum_model_afee0aca_49_computeAssemblyPosError(const void *mech,
...
size_t two_pendulum_model_afee0aca_49_computeAssemblyJacobian(const void *mech,
...
size_t two_pendulum_model_afee0aca_49_computeFullAssemblyJacobian(const void
...
boolean_T two_pendulum_model_afee0aca_49_isInKinematicSingularity(const void
...
void two_pendulum_model_afee0aca_49_convertStateVector(const void *asmMech,
