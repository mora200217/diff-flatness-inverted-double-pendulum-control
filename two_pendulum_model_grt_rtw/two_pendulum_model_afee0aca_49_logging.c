...
PmfMessageId two_pendulum_model_afee0aca_49_recordLog(const
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  xx[1] = 0.20000000005;
  xx[32] = 0.099999999975;
  xx[33] = (2.500000206850927e-11 * input[2] + xx[32] * input[2]) /
    0.02000000000333342;
  xx[34] = xx[1] * xx[33] - input[2];
  xx[35] = 1.2000000002;
  xx[36] = 0.3999999999333334;
  xx[37] = (6.666661667154017e-11 * input[1] + xx[36] * input[1]) /
    0.4800000000533335;
  ...
  xx[38] = xx[32] * xx[11];
  xx[32] = 0.124999999975 - xx[3] * xx[38] * xx[11];
  xx[39] = xx[36] * xx[20];
  xx[36] = 0.4249999999333334 - xx[3] * xx[39] * xx[20];
  xx[40] = xx[3] * xx[38] * xx[6];
  xx[38] = xx[3] * xx[39] * xx[4];
  xx[41] = xx[25];
  xx[42] = - (xx[7] * xx[32] + xx[8] * xx[36]);
  xx[43] = xx[14] * xx[32] - xx[40] * (xx[5] * xx[12] * xx[9] - xx[2] * xx[5] *
    xx[9]) - 3.333416942745674e-11 * xx[9] * xx[26] + xx[23] * xx[36] - xx[38] *
    (xx[16] * xx[21] * xx[18] - xx[15] * xx[16] * xx[18]) -
    1.333334139282454e-10 * xx[18] * xx[27];
  xx[44] = xx[25];
  xx[45] = xx[25];
  ...
  logVector[10] = xx[0] * (xx[37] - 2.500000000138888 * (xx[2] - xx[3] * (xx[1] *
    xx[20] * xx[4] + xx[2] * xx[20] * xx[20])));
  logVector[11] = xx[0] * (xx[33] - 10.00000000083329 * (xx[2] - xx[3] * (xx[1] *
