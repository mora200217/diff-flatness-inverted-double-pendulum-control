...
extern const NeAssertData
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_assertData[];
extern const NeZCData
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_ZCData[];
void
...
void
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_validateRuntimeParameters
  (
...
void
  ...
  (
   ...
   RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
void
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_initializeGeometries
  (
   const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_compDerivs(
...
PmfMessageId
  ...
  (
   ...
   NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_computeAsmModeVector
  (
   const double *, const double *, const double *,
   int *,
   double *,
   NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_computeSimModeVector
  (
   const double *, const double *, const double *,
   int *,
   double *,
   NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_computeZeroCrossings
  (
   const RuntimeDerivedValuesBundle *,
   const double *,
   const double *, const double *, const double *,
   ...
   NeuDiagnosticManager *neDiagMgr);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_recordLog(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
...
void
  ...
  (const void *mech, double *stateVector);
void
...
void
  ...
  (
   ...
   int *modeVector);
PmfMessageId
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_assemble(const
  double *u, double *udot, double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  (void) u;
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  flatness_control_linear_model_inverted_pendulum_afee0aca_49_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initVariables(NeDaePrivateData *smData)
{
  ...
  static const char *varObjects[8] = {
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Rectangular Joint",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Rectangular Joint",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Rectangular Joint",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Rectangular Joint",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Revolute_m1",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Revolute_m1",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Revolute_m2",
    "flatness_control_linear_model_inverted_pendulum/Sistema No lineal Multibody Mask/Revolute_m2"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mSetTargets =
    flatness_control_linear_model_inverted_pendulum_afee0aca_49_setTargets;
  ...
  delegate->mAdjustPosition =
    flatness_control_linear_model_inverted_pendulum_afee0aca_49_adjustPosition;
  ...
  delegate->mPropagateMotion =
    flatness_control_linear_model_inverted_pendulum_afee0aca_49_propagateMotion;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetModeVector =
    flatness_control_linear_model_inverted_pendulum_afee0aca_49_resetModeVector;
